...
player_df <- player_df |>
  mutate(player = case_when(
    player == "Eunan O&#039;Kane" ~ "Eunan Kane",
    player == "N&#039;Golo Kanté" ~ "N Golo Kante",
    player == "Yann M&#039;Vila" ~ "Yann Vila",
    player == "Gary O&#039;Neil" ~ "Gary Neil",
    player == "	John O&#039;Shea" ~ "John Shea",
    player == "Aiden O&#039;Neill" ~ "Aiden Neill",
    TRUE ~ player  # Keep the original value for all other cases
  ))
...
An interesting observation is that Troy Deeney has exactly as many assists as expected. Talk about a good prediction!
...
## Reviewing metrics across positions
...
## Studying the expected goals and opposition's expected goals for all teams
...
## Dissecting performance metrics trends in teams
...
## Assessing the average goals scored by each team
